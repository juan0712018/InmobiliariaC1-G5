 ...
 private PersonaData personaData;
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(t_nom, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           ...
           String nom = t_nom.getText();
            ...
            int  celular = Integer.parseInt(t_celu.getText());
           
            Persona persona = new Persona(nom, dni, celular);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
     if (t_id != null){
        ...
        String nom= t_nom.getText();
         int dni = Integer.parseInt(t_dni.getText());
         int celu = Integer.parseInt(t_celu.getText());
         Persona persona1 = new Persona(nom, dni, celu);
         personaData.actualizarPersona(persona1);
     }
            limpiar();   
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nom = t_nom.getText();
         Persona persona2 = personaData.buscarPersona(nom);
        if(persona2 != null){
            t_id.setText(persona2.getId_persona()+"");
            t_nom.setText(persona2.getNombre());
            t_dni.setText(persona2.getDni()+"");
            t_celu.setText(persona2.getCelular()+"");
        }
